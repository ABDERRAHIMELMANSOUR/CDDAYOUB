...
export const FEATURED_STORY: FeaturedStory | null = {
  ...
  summary: {
    ...
    nl: 'Club des Dirigeants (CDD) Pays-Bas organiseerde met trots een gezamenlijke iftar in Rotterdam, waar Marokkaanse en Turkse ondernemers samenkwamen om de onderlinge verbondenheid en de grensoverschrijdende samenwerking tussen Marokko, Turkije en Nederland te versterken. Onder leiding van voorzitter Nouraddine GRIBI en vanuit de visie van internationaal voorzitter Driss DRIF kwamen senior adviseurs en gewaardeerde deelnemers bijeen tijdens de ramadan. Wij voelden ons in het bijzonder vereerd door de aanwezigheid en steun van Dünya Türk İş Konseyi (het bestuur van DTIK Nederland).',
